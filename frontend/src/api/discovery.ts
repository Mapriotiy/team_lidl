...
export interface DiscoveryRequest { country_codes: string[]; minimum_employees: number; include_unknown_size: boolean; industry: string | null; industries?: string[]; limit: number }
...
export interface DiscoveryRegion { id: string; name: string; country_codes: string[] }
...
export const listDiscoveryRegions = (signal?: AbortSignal) => apiRequest<DiscoveryRegion[]>('/discovery-runs/regions', { signal })
