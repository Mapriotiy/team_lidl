...
export function OutreachDrafts({ companyId }: { companyId: string }) {
  ...
  return <>{headerTarget && createPortal(gmailAction, headerTarget)}<section className="mt-6">
    <div className="rounded-2xl border border-[#CFC7BC] bg-[#FCFBF8] p-5 shadow-[0_10px_35px_rgba(60,45,30,0.06)] sm:p-6">
      <div><p className="text-xs font-bold uppercase tracking-wider text-[#A44818]">Next action</p><h2 className="mt-1 text-lg font-semibold">Contact this company</h2><p className="mt-1 max-w-2xl text-sm leading-6 text-[#68645F]">Turn verified research into a personalized, editable letter. Use the Gmail button in the header to generate or open the draft.</p></div>
