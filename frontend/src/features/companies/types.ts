...
export interface ResearchRun { id: string; status: 'queued' | 'running' | 'completed' | 'partial' | 'failed'; startedAt: string; finishedAt: string; collected: number; assessed: number; warning: string | null; companyName?: string }
