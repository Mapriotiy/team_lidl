...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 flex w-[calc(100vw-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2",
        "max-h-[calc(100vh-4rem)] flex-col gap-6 overflow-y-auto rounded-2xl border border-border bg-card p-6",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute right-4 top-4 rounded-lg p-1 text-muted-foreground transition-colors hover:bg-accent",
